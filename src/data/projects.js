export const projects = [
    {
        ...
        reviews: [
            ...
            { name: "Lakshmi N", role: "User", text: "Customer support is good and the app works smoothly." }
        ]
    },
    {
        id: 106,
        ...
        reviews: [
            ...
            { name: "P. Ravi Teja", role: "Advocate", text: "Excellent resource for welfare schemes information." },
            { name: "M. Sravani", role: "Advocate", text: "The community support features are very well thought out." },
            { name: "B. Kiran Kumar", role: "Legal Associate", text: "Smooth interface and very informative for junior advocates." },
            { name: "G. Swathi", role: "Advocate", text: "Helps us stay connected with welfare updates." }
        ]
    },
    {
        id: 107,
        ...
        reviews: [
            ...
            { name: "K. Harish", role: "Client", text: "Their lead generation strategies are top-notch." },
            { name: "S. Priya", role: "Marketing Head", text: "Very professional team and high-converting designs." },
            { name: "V. Rajesh", role: "Business Owner", text: "We saw 3x growth in inquiries after the new site launch." },
            { name: "N. Kavya", role: "Startup Founder", text: "Best digital partner we could ask for." }
        ]
    },
    {
        id: 108,
        ...
        reviews: [
            ...
            { name: "Dr. Anjali M", role: "Student", text: "The online modules are very easy to navigate and learn from." },
            { name: "Dr. K. Srinivas", role: "Dentist", text: "Great detailed content and smooth user experience." },
            { name: "Dr. R. Manoj", role: "Fellow", text: "Helped me upgrade my clinical skills significantly." },
            { name: "Dr. S. Veena", role: "Student", text: "Registration and course access process is seamless." }
        ]
    },
    {
        id: 109,
        ...
        reviews: [
            ...
            { name: "Er. V. Mahesh", role: "Member", text: "Finally a platform that cares about engineers' welfare." },
            { name: "Er. K. Deepa", role: "Civil Engineer", text: "The insurance claim process guide is very clear." },
            { name: "Er. M. Balaji", role: "Software Engineer", text: "Good networking opportunities provided here." },
            { name: "Er. N. Sushma", role: "Student Member", text: "Helpful for career guidance and technical support." }
        ]
    },
    {
        id: 110,
        ...
        reviews: [
            ...
            { name: "Dr. A. Madhavi", role: "Student", text: "Information about courses is very well organized." },
            { name: "Dr. B. Prasad", role: "Alumni", text: "Proud to be part of an academy with such a professional portal." },
            { name: "Dr. K. Suman", role: "Orthodontist", text: "Enrolling in advanced courses was a breeze." },
            { name: "Dr. P. Latha", role: "Dentist", text: "Great visuals and detailed curriculum explanation." }
        ]
    },
    {
        id: 103,
        ...
        reviews: [
            ...
            { name: "Dr. S. Aruna", role: "Member", text: "Feeling more secure knowing about these welfare schemes." },
            { name: "Dr. M. Kiran", role: "Surgeon", text: "Transparent and easy to understand policies." },
            { name: "Dr. G. Ravi", role: "Member", text: "The nominee benefit registration was simple." },
            { name: "Dr. T. Padma", role: "Dentist", text: "A great initiative for the medical fraternity." }
        ]
    },
    {
        id: 111,
        ...
        reviews: [
            ...
            { name: "Sneha K", role: "Parent", text: "Loved the gallery on the website, made me book immediately!" },
            { name: "Rahul V", role: "Parent", text: "Very professional service and the site gave all details clearly." },
            { name: "Mamatha G", role: "Parent", text: "Ordered a casting for my newborn, amazing work." },
            { name: "Priya D", role: "Parent", text: "Beautiful way to preserve memories." }
        ]
    },
    {
        id: 112,
        ...
        reviews: [
            ...
            { name: "N. Sai Kumar", role: "Job Seeker", text: "Got placed in a top MNC through this portal." },
            { name: "T. Anjali", role: "HR Manager", text: "Posting jobs and screening candidates is very efficient." },
            { name: "P. Arjun", role: "Job Seeker", text: "Better than other portals, very relevant matches." },
            { name: "M. Divya", role: "Job Seeker", text: "User interface is clean and easy to use." }
        ]
    },
    {
        id: 113,
        ...
        reviews: [
            ...
            { name: "K. Sujatha", role: "Teacher", text: "A great support system for private teachers." },
            { name: "R. Naresh", role: "Lecturer", text: "The emergency assistance feature gives peace of mind." },
            { name: "S. Vani", role: "Principal", text: "Recommended this to all my staff members." },
            { name: "P. Srinivas", role: "Tutor", text: "Very informative and helpful community." }
        ]
    },
    {
        id: 114,
        ...
        reviews: [
            ...
            { name: "K. Raju", role: "Patient", text: "Best dental hospital in Madhapur. Website info is accurate." },
            { name: "L. Swapna", role: "Patient", text: "Read about the doctors online and felt confident visiting." },
            { name: "M. Ganesh", role: "Patient", text: "State of the art facilities shown on site are real." },
            { name: "N. Hema", role: "Patient", text: "Very happy with my root canal treatment." }
        ]
    },
    {
        id: 115,
        ...
        reviews: [
            ...
            { name: "R. Vijay", role: "Vendor", text: "Got many leads for my plumbing business." },
            { name: "K. Jyothi", role: "User", text: "Found a good electrician nearby within minutes." },
            { name: "S. Mahesh", role: "User", text: "Very useful for finding local services." },
            { name: "V. Lakshmi", role: "Vendor", text: "Good exposure for small businesses." }
        ]
    },
    {
        id: 116,
        ...
        reviews: [
            ...
            { name: "K. Sandhya", role: "User", text: "Uploaded all our old albums, looks great!" },
            { name: "R. Amit", role: "User", text: "Secure place for private family photos." },
            { name: "S. Neha", role: "User", text: "Shared credentials feature is very convenient for family." },
            { name: "M. Rahul", role: "User", text: "Best way to digitally store memories." }
        ]
    },
    {
        id: 117,
    ...
    },
    {
        ...
        reviews: [
            ...
            { name: "Suresh Reddy", role: "Subscriber", text: "Reliable chit fund schemes, very happy with the returns." },
