...
const Program = () => {
    return (
        <main className="min-h-screen pt-28 pb-12 px-4 bg-primary relative overflow-hidden flex items-center justify-center">
            <SEO
                title="Program | Coming Soon"
                description="Our upcoming programs at Koderspark. Stay tuned for something amazing."
