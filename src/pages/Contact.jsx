...
const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await fetch("https://script.google.com/macros/s/AKfycbxATTh3r0d-ZiYrPI8XB2beBi69fU_caXJd5rLmMgQg87nnkwaD9eYMzrGQv8u23dTe/exec", {
                method: 'POST',
            ...
            setStatus('success');
            toast.success('Registration/Message sent successfully! We\'ll get back to you soon.');
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
                    ...
                    >
                        ...
                        <p className="text-slate-300 text-lg mb-12 leading-relaxed max-w-lg">
                            Ready to upgrade your skills or build something great? Fill out the form to register for our courses or discuss your project.
                        </p>
                        ...
                        <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md p-8 md:p-10 rounded-3xl border border-white/10 shadow-2xl relative overflow-hidden">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-sm font-medium text-slate-200 ml-1">Mobile Number</label>
                                        <input
                                            type="tel"
                                            name="mobile"
                                ...
                                <div className="space-y-2">
                                    <label className="text-sm font-medium text-slate-300 ml-1">Message / Course Details</label>
                                    <textarea
                                        rows="5"
                                        name="message"
